...
import com.wuming.model.LoadInfo;
...
public class Downloader {
    ...
    private void init() {  
        try {  
            ...
            URL url = new URL(HttpUtils.BASE_URL+HttpUtils.SERVLET_DOWNLOADFILE);  
            HttpURLConnection connection = (HttpURLConnection) url.openConnection(); 
            connection.setDoOutput(true);
            StringBuffer stringBuffer =new StringBuffer();
            stringBuffer.append("downloadfile").append("=").append(urlstr);
